...
export default function SkinTankMenu () {
    return (
        <Layout>
            <div className="flex flex-col flex-wrap items-center h-[85vh] w-[100vw]">
                <motion.h1
                    animate={{scale: [0, 1]}}
                    transition={{duration: 1}}
                    className="absolute font-title shadow-black shadow-2xl top-[6vh] flex flex-row flex-wrap justify-center items-center text-7xl w-[80vw] h-[15vh] border-solid border-[0.5rem] rounded-xl"
